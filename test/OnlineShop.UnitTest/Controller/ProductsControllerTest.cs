...
namespace OnlineShop.UnitTest.Controller
{
    public class ProductsControllerTest
    {
        ...
        [Fact]
        public async Task ProductsController_AddProducts_Should_Return_NotFoundResonse_When_ProductsIsNullOrEmpty()
        {
        ...
        [Fact]
        public async Task ProductsController_AddProducts_Should_Return_OkResponse_When_ProductsIsNullOrEmpty()
        {
            var productsController = new ProductsController(_moqMediator.Object);
        ...
        [Fact]
        public async Task ProductsController_AddProducts_Should_Return_BadRequest_When_ResponseIsNullOrEmpty()
        {
            var productsController = new ProductsController(_moqMediator.Object);
        ...
        [Fact]
        public async Task ProductsController_AddProducts_Should_Return_HttpStatusCode_Ok_When_ResponseIsNotNullOrEmpty()
        {
            var productsController = new ProductsController(_moqMediator.Object);
