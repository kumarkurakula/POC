...
namespace OnlineShop.UnitTest.Controller
{
    public class OrdersControllerTest
    {
        ...
        [Fact]
        public async Task OrderController_CreateOrder_Should_Return_BadRequest_When_ResponseIsNullOrEmpty()
        {
        ...
        [Fact]
        public async Task OrderController_CreateOrder_Should_Return_HttpStatusCode_Ok_When_ResponseIsNotNullOrEmpty()
        {
            var orderController = new OrderController(_moqMediator.Object);
